                        ...
                        <table id="example" class="display" style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $item->title }}</td>
                                    <td>
                                        <a class="btn btn-primary btn-sm" href="{{ asset('/admin/contact_us/edit') }}/{{ $item->id }}">查看</a>
                                        <form style="display: inline-block" action="{{ asset('/admin/contact_us/delete') }}/{{ $item->id }}" method="POST">
                                            @csrf
                                            @method('delete')
